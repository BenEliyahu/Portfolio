...
const projects = [
  ...
  },
  {
    ...
    tech: ['C#', '.NET', 'Design Patterns', 'REST API'],
  ...
  },
  {
    ...
    tech: ['React', 'TypeScript', 'Firebase', 'OpenAI API', 'Tailwind CSS'],
  ...
  },
  {
    id: 5,
    title: 'MovieIL',
    description: 'Movie discovery app built with React. Dynamic content, global state management, and a rich interactive UI with ratings and carousels.',
    tech: ['React', 'Firebase', 'Zustand', 'React Router'],
